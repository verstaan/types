...
import * as xCats from "./categories.json";
...
// export const AllReportTypes: reportType[] = Object.values(xCats)
...
export type AutoVerificationFailure =
...
export type PendingAampReportUpdate = Partial<
  Omit<PendingAampReport, "fields">
> & {
  id: number;
