...
export const createOsReport = (report: NewOsReport): Promise<void> => request<void>(true, {
    method: "post",
...
export const getContainers = (): Promise<Container[]> => request<Container[]>(false, {
    method: "get",
...
export const getDefaultRegions = (): Promise<DefaultRegion[]> => request<DefaultRegion[]>(false, {
    method: "get",
    url: "/public/getDefaultRegions"
});

export const getReports = (): Promise<PublicReport[]> => request<PublicReport[]>(false, {
    method: "get",
